...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">initiumtest documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-99a2fa78602bdfb1743e1e6b101a46c4"' : 'data-target="#xs-components-links-module-AppModule-99a2fa78602bdfb1743e1e6b101a46c4"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-99a2fa78602bdfb1743e1e6b101a46c4"' :
                                            'id="xs-components-links-module-AppModule-99a2fa78602bdfb1743e1e6b101a46c4"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/TurnGenerateComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TurnGenerateComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/ReloadData.html" data-type="entity-link">ReloadData</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/QueueProvider.html" data-type="entity-link">QueueProvider</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/URLProvider.html" data-type="entity-link">URLProvider</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/QueueCat.html" data-type="entity-link">QueueCat</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
